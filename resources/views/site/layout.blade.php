    ...
    <nav class="red">
        <div class="nav-wrapper container">
          ...
          <ul id="nav-mobile" class="left">
            ...
            <li><a href="" class="dropdown-trigger btn red" data-target='dropdown1'"> Categorias <i class="material-icons right">expand_more</i></a></li>
        ...
        <ul id="nav-mobile" class="right">
            <li><a href="" class="dropdown-trigger btn red" data-target='dropdown2'"> Olá {{auth()->user()->Firstname}} <i class="material-icons right">expand_more</i></a></li>   
        </ul>
        @else
        <ul id="nav-mobile" class="right">
